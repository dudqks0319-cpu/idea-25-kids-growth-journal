...
import 'package:app_25_kids_growth_journal/app.dart';
import 'package:app_25_kids_growth_journal/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('아이 성장 기록 저널'), findsWidgets);
